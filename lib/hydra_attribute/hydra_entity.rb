  ...
  module HydraEntity
    ...
    module ClassMethods
      ...
      def hydra_attributes
        @hydra_attributes ||= RelationDecorator.new(model_name.name, ::HydraAttribute::HydraAttribute)
      end
      ...
      # @return [HydraAttribute::HydraEntity::RelationDecorator]
      def hydra_sets
        @hydra_sets ||= RelationDecorator.new(model_name.name, ::HydraAttribute::HydraSet)
      end
    end
